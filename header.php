...
<body>
    <nav class="main-nav wrapper-container">
        <div class="wrapper">
            <a href="#" class="brand-name heading-text">GharJagga</a>
            <button class="resp-menu-btn">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item"><a href="#" class="menu-link">Rent</a></li>
                <li class="menu-item"><a href="#" class="menu-link">Blog</a></li>
            </ul>
            <ul class="menu-list secondary-list">
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <button type="button" class="btn btn-primary-outline property-btn">
